      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div ref={imageRef} className="relative">
            <div className="aspect-[4/5] bg-cover bg-center rounded-lg shadow-2xl"
                 style={{
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-amber-600 rounded-lg opacity-20"></div>
          </div>
          ...
          <div ref={contentRef} className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-8 pt-8">
              <div className="text-center">
                <div className="text-3xl font-light text-amber-600 mb-2">150+</div>
                <div className="text-sm tracking-wide text-gray-500">LUXURY ROOMS</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-light text-amber-600 mb-2">24/7</div>
                <div className="text-sm tracking-wide text-gray-500">CONCIERGE</div>
              </div>
            </div>
          </div>
        </div>
