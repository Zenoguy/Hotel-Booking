          ...
          {rooms.map((room, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <button className="group/btn w-full bg-gray-900 text-white py-3 px-6 text-sm font-light tracking-widest hover:bg-amber-600 transition-all duration-300 flex items-center justify-center">
                  VIEW DETAILS
